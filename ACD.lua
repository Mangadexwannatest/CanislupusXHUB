            ...
            for val = 1,#getgenv().Playing do
                for i,v in pairs(getgenv().Playing [val]) do
                    ...
                    elseif i == "AutoUltToggle" and check_index_values(v["Index"]) then
                        wait_for(v,val,"new",{["1"] = "Waiting For Wave : "..tostring(v["Wave"]),["2"] = "Waiting For Time : "..tostring(v["Time"]),["3"] = "Action : AutoUltToggle",["4"] = "Value : "..tostrong(v["Value"]),["5"] = "UnitID : "..tostring(v["UnitID"]),["6"] = "Ult Name : "..tostring(v["UltName"]),["7"] = "Unit Index : "..tostring(v["Index"])  })
