...
do
    ...
    game.Players.LocalPlayer.PlayerGui.ChildAdded:Connect(function(v)
        if v.Name == "EndGameUI" then
            ...
            repeat
                firesignal(v:WaitForChild("BG"):WaitForChild("Buttons"):WaitForChild(Options.ActionMissionEnd.Value):WaitForChild("Button").MouseButton1Click,game.Players.LocalPlayer)
                wait(1)
            until not v.Parent
        end
    end)
